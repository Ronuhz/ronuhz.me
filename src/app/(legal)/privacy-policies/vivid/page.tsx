...
export default function SpookyPrivacyPolicy() {
  const lastUpdated = 'March 02, 2025';
  const appName = 'Vivid';
      ...
      <section className="space-y-6">
        ...
        <PolicySection title="5. Third-Party Services">
          ...
          <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
            ...
            <li>
              <PolicyLink href="https://fal.ai/privacy">Fal.ai</PolicyLink>
            </li>
            <li>
        ...
        <PolicySection title="6. Use of AIProxy and Replicate/Fal.ai Services">
          <PolicyParagraph>
            The Application allows users to generate images from prompts. When an image is generated by the user, the following process occurs:
          </PolicyParagraph>
          <ul className="list-disc list-inside opacity-80 space-y-2 ml-4">
            <li>The prompt is first transmitted to AIProxy, a service that acts as an intermediary between the Application and Replicate/Fal.ai. AIProxy masks the API key to protect it during the communication process.</li>
            <li>The prompt is then forwarded to Replicate/Fal.ai, where using AI models an image is generated.</li>
          ...
          <PolicyParagraph>
            ...
            <PolicyLink href="https://replicate.com/privacy">Replicate Privacy Policy</PolicyLink>, <PolicyLink href="https://fal.ai/privacy">Fal.ai Privacy Policy</PolicyLink>{' '}and the{' '}
