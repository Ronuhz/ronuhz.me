...
export default function SpookyPrivacyPolicy() {
  const lastUpdated = 'January 04, 2025';
  const appName = 'Spooky';
    ...
    <main className="max-w-3xl mx-auto py-8 px-4">
      ...
      <section className="space-y-6">
        ...
        <PolicySection title="6. Use of AIProxy and Replicate Services">
          ...
          <ul className="list-disc list-inside text-gruvbox-fg/80 space-y-2 ml-4">
            <li>The prompt is first transmitted to AIProxy, a service that acts as an intermediary between the Application and Replicate. AIProxy masks the API key to protect it during the communication process.</li>
