  ...
  return (
    <main className="max-w-3xl mx-auto py-8 px-4">
      ...
      <section className="space-y-6">
        ...
        <PolicySection title="6. Use of AIProxy and OpenAI Services">
          <PolicyParagraph>
            The Application allows users to generate images based on provided details. When a user fills out details about an action figure and its accessories and presses generate, the following process occurs:
          </PolicyParagraph>
          <ul className="list-disc list-inside text-gruvbox-fg/80 space-y-2 ml-4">
            <li>The provided image and additional descriptive text are first transmitted to AIProxy, a service that acts as an intermediary and masks the API key during communication.</li>
            <li>AIProxy forwards the image and descriptive text to OpenAI, where the AI model generates an image.</li>
            <li>The generated image is sent back to AIProxy, which relays the result back to the user within the Application.</li>
          </ul>
          <PolicyParagraph>
            It is important to note that no facial recognition or facial feature extraction is performed on the provided images. Additionally, no data is stored online by the Application. All data generated by the Application is stored locally on the user&apos;s device. Users are encouraged to review the{' '}
            <PolicyLink href="https://www.aiproxy.pro/privacy.html">AIProxy Privacy Policy</PolicyLink> and the 
