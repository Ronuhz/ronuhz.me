...
export default function SpookyPrivacyPolicy() {
  const lastUpdated = 'February 02, 2025';
  const appName = 'Oneiro';
    ...
    <main className="max-w-3xl mx-auto py-8 px-4">
      ...
      <section className="space-y-6">
        ...
        <PolicySection title="2. Data Collection and Storage">
          <PolicyParagraph>
            All user-generated content, including dream entries, interpretations, and visualizations, is stored locally on the user's device. While the Application processes dream content through third-party services to generate interpretations and visualizations, this data is not permanently stored on our servers. Generated visualizations are temporarily retained for quality assurance purposes for a maximum period of one hour, after which they are automatically deleted from our systems. The Developer has no access to dream contents or their interpretations at any time.
          </PolicyParagraph>
        </PolicySection>
        ...
        <PolicySection title="5. Third-Party Services">
          ...
          <ul className="list-disc list-inside text-gruvbox-fg/80 space-y-2 ml-4">
            ...
            <li>
              <PolicyLink href="https://openai.com/policies/row-privacy-policy/">OpenAI</PolicyLink>
            </li>
          </ul>
          <PolicyParagraph>
        ...
        <PolicySection title="6. Use of AIProxy, OpenAI, and Replicate Services">
          <PolicyParagraph>
            The Application allows users to create and interpret dreams with AI-generated visualizations. When a dream is created by the user, the following process occurs:
          </PolicyParagraph>
          <ul className="list-disc list-inside text-gruvbox-fg/80 space-y-2 ml-4">
            <li>The dream content is first transmitted to AIProxy, which acts as an intermediary between the Application and third-party services. AIProxy masks the API keys to protect them during the communication process.</li>
            <li>AIProxy forwards the content to OpenAI, where an interpretation of the dream is generated.</li>
            <li>The content is then processed again through AIProxy and OpenAI to create an image generation prompt.</li>
            <li>This image generation prompt is sent through AIProxy to Replicate, where an AI model generates the visualization.</li>
            <li>The interpretation and generated image are sent back through AIProxy, which relays the results to the user within the Application.</li>
          </ul>
          <PolicyParagraph>
            It is important to note that while the content is processed by OpenAI and Replicate, the Developer does not have access to the dream contents or their interpretations. The generated visualizations are temporarily accessible to the Developer for quality assurance purposes for a period of one hour, after which they are automatically deleted from the system. All dream content, interpretations, and visualizations are stored locally on the user's device. The processing is conducted solely for the purpose of providing the user with the requested service, and any data transmitted is handled according to the respective privacy policies of the third-party services. Users are encouraged to review the{' '}
            <PolicyLink href="https://openai.com/policies/row-privacy-policy/">OpenAI Privacy Policy</PolicyLink>,{' '}
            <PolicyLink href="https://replicate.com/privacy">Replicate Privacy Policy</PolicyLink>,{' '}and{' '}
        ...
        <PolicySection title="7. Amendments to the Privacy Policy">
          <PolicyParagraph>
            The terms of this Privacy Policy are subject to modification at the sole discretion of the Developer. Users are encouraged to review this Policy periodically to remain informed of any changes. Continued use of the Application following the posting of any amendments constitutes acceptance of the revised terms.
          </PolicyParagraph>
        </PolicySection>
      </section>
    </main>
