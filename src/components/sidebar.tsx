...
export default function Sidebar() {
    ...
    return (
        <div className="z-10 fixed bottom-0 left-0 w-full md:w-auto md:top-1/2 md:-translate-y-1/2 md:left-8 md:bottom-auto bg-gruvbox-bg/60 backdrop-blur-lg shadow-lg md:bg-transparent md:backdrop-blur-none">
    ...
    return (
        <Link 
            ...
            className={`flex flex-col md:flex-row items-center gap-2 md:gap-3 px-3 py-2 rounded-md transition-all duration-200 
                ${isActive
                    ? 'text-gruvbox-bright-blue md:bg-gruvbox-bg/40 md:translate-x-1'
                    : 'text-gruvbox-fg hover:text-gruvbox-bright-blue hover:md:bg-gruvbox-bg/10'}`}
        >
